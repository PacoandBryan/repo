...
export default function SweetsPage() {
  ...
  return (
    <>
      <NextSeo
        title="Traditional Mexican Sweets & Candies | Paco & Bryan"
        description="Discover our collection of authentic Mexican sweets and candies, handcrafted by local artisans using traditional recipes and techniques. Experience the rich flavors of Mexico."
        canonical="https://yoursite.com/sweets"
        openGraph={{
          url: 'https://yoursite.com/sweets',
          title: 'Traditional Mexican Sweets & Candies | Paco & Bryan',
          description: 'Discover authentic Mexican sweets and candies, handcrafted by local artisans using traditional recipes.',
          images: sweets.map(sweet => ({
            url: sweet.images[0],
            width: 1200,
            height: 630,
            alt: sweet.name,
        ...
        additionalMetaTags={[
          {
            name: 'keywords',
            content: 'mexican sweets, traditional candies, dulces mexicanos, artisanal sweets, handmade candies'
          },
          {
            name: 'robots',
      ...
      <JsonLd
        item={{
          ...
          "@type": "CollectionPage",
          name: "Traditional Mexican Sweets Collection",
          description: "Authentic Mexican sweets and candies handcrafted by local artisans",
          url: "https://yoursite.com/sweets",
          about: {
            "@type": "Thing",
            name: "Mexican Traditional Sweets"
          },
          offers: {
            "@type": "AggregateOffer",
            priceCurrency: "MXN",
            lowPrice: Math.min(...sweets.map(s => s.price)),
            highPrice: Math.max(...sweets.map(s => s.price)),
            offerCount: sweets.length
          },
          itemListElement: sweetStructuredData
        }}
      />
      <div className="pt-16">
        {/* Hero Section */}
